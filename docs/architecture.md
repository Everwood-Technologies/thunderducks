...
- User root: **WebAuthn/passkey RPC ceremony** (ES256) + device-link for multi-device
...
- **Web TS:** rooms UX + passkey begin/list + device-link; local `td-node` RPC (HTTP JSON; SSE later)
- Tauri deferred
